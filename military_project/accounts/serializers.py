...
class CarSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Car
        fields = ['id', 'model', 'car_type', 'year', 'country', 'color',
                  'mark', 'wheel_type', 'car_number']


class DossierSerializer(serializers.ModelSerializer):
    cars = CarSerializer(many=True,required=False,allow_null=True) #required = False
    class Meta:
        model = Dossier
        fields = ['id','image','full_name','address','department',
                  'date_birth','phone','experience','cars']
